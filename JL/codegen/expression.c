...
ImplExpression(unary_expression,
    Or(And(Type(TILDE), unary_expression), And(Type(EXCLAIM), unary_expression),
...
ImplExpression(assignment_tuple,
...
//    \n
//    expression \n
ImplExpression(expression_statement, Ln(tuple_expression));
...
ImplExpression(field_statement, And(TypeLn(FIELD), function_argument_list));
...
// class_constructors
//    : class_constructor_list
ImplExpression(class_constructors, And(TypeLn(COLON), class_constructor_list));
...
ImplExpression(parent_class_list, And(Ln(identifier), parent_class_list1));

// parent_classes
//    : parent_class_list
ImplExpression(parent_classes, And(TypeLn(COLON), parent_class_list));
...
// module_statement
//    module identifier
ImplExpression(module_statement,
...
ImplExpression(statement_list1, Or(And(statement, statement_list1), Epsilon));
ImplExpression(statement_list, And(statement, statement_list1));
